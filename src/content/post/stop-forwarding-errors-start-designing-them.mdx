...
We have a name for this. We call it "Error Handling." But the instance above is no more than **Error Forwarding**. We treat errors like hot potatoes--catch them, wrap them (maybe), and throw them up the stack as fast as possible.
...
The problem? It's *over* convenient.
...
It's a nice, simple rule. It's also not quite right. As [Luca Palmieri notes](https://lpalmieri.com/posts/error-handling-rust/): "It is not the right framing. You need to reason about intent."
